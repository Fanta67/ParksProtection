...
class GUITests(unittest.TestCase):
    ...
    def test_animals_related_parks(self):  # 9
        ...
        time.sleep(3)
        button_name = self.driver.find_element_by_link_text(
    ...
    def test_parks_search(self):  # 11
        self.driver.get("localhost:3000/Parks/search")
        time.sleep(3)
    ...
    def test_animals_search(self):  # 12
        self.driver.get("localhost:3000/Animals/search")
        time.sleep(3)
        expected_result = "Results"
        actual_result = self.driver.find_element_by_class_name("PageHeader").text
    ...
    def test_plants_search(self):  # 13
        self.driver.get("localhost:3000/Plants/search")
        time.sleep(3)
        expected_result = "Results"
        actual_result = self.driver.find_element_by_class_name("PageHeader").text
    ...
    def test_parks_search_results_1(self):  # 14
        ...
        search_bar = self.driver.find_element_by_class_name("searchBar")
